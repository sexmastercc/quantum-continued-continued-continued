...
public class HUD extends Module {
    ...
    public Setting<String> gameTitle = register(new Setting("AppTitle", "Quantum+++ v0.0.1"));
    ...
    private final Setting<String> waterMarkName = register(new Setting("WaterMarkName", "Quantum+++ v0.0.1", v -> this.waterMark.getValue()));
